...
//variables servant à lier main et gfxlib pour redimmensionnement
int varLargeurFenetre;
int varHauteurFenetre;
...
static void fonctionRedimensionnement(int largeur, int hauteur)
{
	...
	sLargeurFenetre = largeur;
	//printf("sLargeurFenetre = %d\n", sLargeurFenetre);
	varLargeurFenetre = largeur;
	//printf("varLargeurFenetre gfx = %d\n", varLargeurFenetre);
	
	sHauteurFenetre = hauteur;
	//printf("sHauteurFenetre = %d\n", sHauteurFenetre);
	varHauteurFenetre = hauteur;
	//printf("varHauteurFenetre gfx = %d\n", varHauteurFenetre);
