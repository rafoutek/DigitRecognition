...
//png functions---------------------------------------------- these png functions has not been tested yet !
...
void test_png_functions() {

	int width, heigth;
	char *filename = "./img_learn/0.8.jpg";
...
//end of png functions----------------------------------------------these png functions above has not been tested yet !
